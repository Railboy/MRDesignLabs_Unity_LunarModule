...
namespace Holotoolkit.Unity.Dialogs
{
    ...
    public class LoadingDialog : Singleton<LoadingDialog>
    {
        ...
        // The progress bar renderer - used for changing color
        [SerializeField]
        ...
        private Color smoothProgressColor = Color.white;
        ...
        public void SetProgressColor (Color newProgressColor) {
        ...
        private void Update ()
        {
            smoothProgressColor = Color.Lerp(smoothProgressColor, progressColor, Time.deltaTime * SmoothProgressSpeed);
            ...
            progressBarRenderer.material.color = smoothProgressColor;
