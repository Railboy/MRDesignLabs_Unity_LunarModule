    ...
    public class LocalHandInput : MonoBehaviour
    {
        ...
        protected void Update() {
                ...
                /*if (handState != null) {
                    ...
                    if (handState.Pressed) {
                        ...
                        if (!pressed) {
                            ...
                            worldHeadPosOnPressed = Camera.main.transform.position;
                            worldHeadRotOnPressed = Camera.main.transform.eulerAngles;
            ...
            if (pressed) {
                ...
                transformHelper.position = Camera.main.transform.position;// Camera.main.transform.position;
                transformHelper.rotation = Camera.main.transform.rotation;// Camera.main.transform.rotation;
                ...
                Vector3 localHeadPosNow = Vector3.zero;// transformHelper.InverseTransformPoint(Camera.main.transform.position);
